...
public final class GreeterServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.lugf.grpc.greeter.GreeterRequest,
      com.lugf.grpc.greeter.GreeterReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.lugf.grpc.greeter.GreeterRequest.class,
      responseType = com.lugf.grpc.greeter.GreeterReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lugf.grpc.greeter.GreeterRequest,
      com.lugf.grpc.greeter.GreeterReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.lugf.grpc.greeter.GreeterRequest, com.lugf.grpc.greeter.GreeterReply> getSayHelloMethod;
      ...
      synchronized (GreeterServiceGrpc.class) {
        if ((getSayHelloMethod = GreeterServiceGrpc.getSayHelloMethod) == null) {
          GreeterServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.lugf.grpc.greeter.GreeterRequest, com.lugf.grpc.greeter.GreeterReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lugf.grpc.greeter.GreeterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lugf.grpc.greeter.GreeterReply.getDefaultInstance()))
  ...
  public static abstract class GreeterServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.lugf.grpc.greeter.GreeterRequest request,
        io.grpc.stub.StreamObserver<com.lugf.grpc.greeter.GreeterReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.lugf.grpc.greeter.GreeterRequest,
                com.lugf.grpc.greeter.GreeterReply>(
  ...
  public static final class GreeterServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterServiceBlockingStub> {
    ...
    /**
     */
    public com.lugf.grpc.greeter.GreeterReply sayHello(com.lugf.grpc.greeter.GreeterRequest request) {
  ...
  public static final class GreeterServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lugf.grpc.greeter.GreeterReply> sayHello(
        com.lugf.grpc.greeter.GreeterRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.lugf.grpc.greeter.GreeterRequest) request,
              (io.grpc.stub.StreamObserver<com.lugf.grpc.greeter.GreeterReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.lugf.grpc.greeter.GreeterProto.getDescriptor();
    }
